...
1. Use the countries_data.py ([https://github.com/Asabeneh/30-Days-Of-Python/blob/master/data/countries-data.py](https://github.com/Asabeneh/30-Days-Of-Python/blob/master/data/countries-data.py)) file and follow the tasks below:
